...
GECKO_TERMINAL_MAX_REQUESTS_PER_CYCLE = 25 if _RUNNING_MODE else 3

NOTIFICATION_PUMP_COOLDOWN = _get_time(hours=2) if _RUNNING_MODE else _get_time(minutes=1)
